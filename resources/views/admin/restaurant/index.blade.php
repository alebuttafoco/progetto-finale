            ...
            @foreach ($restaurants as $restaurant)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger" data-toggle="modal" data-target="#deleteModalID{{ $restaurant->id }}"><i
                                class="fas fa-trash-alt"></i></a>

                        <!-- Modal -->
                        <div class="modal fade" id="deleteModalID{{ $restaurant->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Eliminazione - Ristorante N.{{ $restaurant->id }}</h5>
                                    </div>
